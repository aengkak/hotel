            ...
            <table id="example1" class="table table-bordered table-striped">
              ...
              <?php $no=1; foreach ($user as $u): ?>
                <tr>
                  ...
                  <td><button class="btn btn-warning fa fa-edit" onclick="edituser(<?php echo $u->id_us;?>)"></button>
							        <button class="btn btn-danger fa fa-close" onclick="deleteuser(<?php echo $u->id_us;?>)"> </button>
                  </td>
                </tr>
              <?php $no++; endforeach; ?>
              </tbody>
...
<script>
  var save_method1; //for save method string
    ...
    function edituser(id)
    {
      ...
      $('#form')[0].reset(); // reset form on modals
      $('#modal_form').modal('show'); // show bootstrap modal
      $("#modalbody").load("useredit/"+id,function(data){
		      $("#modalbody").html(data);
          //iCheck for checkbox and radio inputs
          $('input[type="checkbox"].minimal, input[type="radio"].minimal').iCheck({
            checkboxClass: 'icheckbox_minimal-blue',
